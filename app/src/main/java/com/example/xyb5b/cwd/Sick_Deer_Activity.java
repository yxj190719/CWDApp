...
public class Sick_Deer_Activity extends ActionBarActivity implements Deer_Collector_Fragment.OnFragmentInteractionListener, Deer_Location_Fragment.OnFragmentInteractionListener,MenuFragment2.OnFragmentInteractionListener {
    ...
    public void onPreviousButtonClicked(int i) {
        ...
        //Deer_Collector_Fragment dcf = (Deer_Collector_Fragment) fg.findFragmentByTag("dcf");
        //Deer_Location_Fragment dlf = (Deer_Location_Fragment) fg.findFragmentByTag("dlf");
        //Hunter_Harvested_Fragment hhf = (Hunter_Harvested_Fragment) fg.findFragmentByTag("hhf");
        //Targeted_Harvest_Fragment thf = (Targeted_Harvest_Fragment) fg.findFragmentByTag("thf");
    ...
    public void onNextButtonClicked(int i) {
        ...
        switch (i) {
            case 1:
                ...
                transaction.commit();
                Button nb=(Button)dlf.getView().findViewById(R.id.next_button);
                nb.setText("Done");
            ...
            case 2:
                ...
                if(System.currentTimeMillis()-mExitTime>3000){
                    ...
                    db.close();
                    //Toast.makeText(getApplicationContext(), ((TextView) this.findViewById(R.id.cwd_sampleNum1)).getText() + " has been saved!", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(this, Sick_Deer_Activity.class);
